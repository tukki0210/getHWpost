...
export const createPostData = ({ prefNum, kiboSyokusyu = '09%2C10%2C4%20%2C5', freeWord = '' }) => {
...
export const getPostByPref = async (data) => {
...
export const postSlack = async (token, channel, results, date) => {
